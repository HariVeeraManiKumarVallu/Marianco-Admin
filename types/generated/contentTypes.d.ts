...
export interface ApiEventAttendeeEventAttendee extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    locale: Schema.Attribute.String & Schema.Attribute.Private
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::event-attendee.event-attendee'> &
      Schema.Attribute.Private
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    isPastEvent: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>
    locale: Schema.Attribute.String & Schema.Attribute.Private
    ...
    maxAttendance: Schema.Attribute.Integer & Schema.Attribute.Required
    publishedAt: Schema.Attribute.DateTime
    slug: Schema.Attribute.UID<'title'> & Schema.Attribute.Required
    summary: Schema.Attribute.Text & Schema.Attribute.Required
    time: Schema.Attribute.Time
    title: Schema.Attribute.String & Schema.Attribute.Required
    totalAttending: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          min: 0
        },
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    isPaid: Schema.Attribute.Boolean & Schema.Attribute.Required & Schema.Attribute.DefaultTo<false>
    locale: Schema.Attribute.String & Schema.Attribute.Private
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::order.order'> &
      Schema.Attribute.Private
    orderItems: Schema.Attribute.Relation<'oneToMany', 'api::order-item.order-item'>
...
export interface ApiProductImageProductImage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    locale: Schema.Attribute.String & Schema.Attribute.Private
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::product-image.product-image'> &
      Schema.Attribute.Private
    publishedAt: Schema.Attribute.DateTime
    updatedAt: Schema.Attribute.DateTime
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private
    url: Schema.Attribute.String & Schema.Attribute.Required
    variants: Schema.Attribute.Relation<'manyToMany', 'api::product-variant.product-variant'>
  }
}

export interface ApiProductOptionTypeProductOptionType extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime
    type: Schema.Attribute.String & Schema.Attribute.Required & Schema.Attribute.Unique
    updatedAt: Schema.Attribute.DateTime
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private
  }
}

export interface ApiProductOptionValueProductOptionValue extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private
    optionId: Schema.Attribute.Integer & Schema.Attribute.Required & Schema.Attribute.Unique
...
export interface ApiProductVariantProductVariant extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdAt: Schema.Attribute.DateTime
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private
    images: Schema.Attribute.Relation<'manyToMany', 'api::product-image.product-image'>
    ...
    isEnabled: Schema.Attribute.Boolean &
      ...
      Schema.Attribute.DefaultTo<false>
    locale: Schema.Attribute.String & Schema.Attribute.Private
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::product-variant.product-variant'> &
      Schema.Attribute.Private
    ...
    updatedAt: Schema.Attribute.DateTime
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private
    variantId: Schema.Attribute.Integer & Schema.Attribute.Required & Schema.Attribute.Unique
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    productCategory: Schema.Attribute.Relation<
      ...
      'api::product-category.product-category'
    >
    productId: Schema.Attribute.String & Schema.Attribute.Required & Schema.Attribute.Unique
    publishedAt: Schema.Attribute.DateTime
...
export interface ApiSkuSku extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private
    locale: Schema.Attribute.String & Schema.Attribute.Private
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::sku.sku'> & Schema.Attribute.Private
    order_items: Schema.Attribute.Relation<'oneToMany', 'api::order-item.order-item'>
    product: Schema.Attribute.Relation<'manyToOne', 'api::product.product'>
    publishedAt: Schema.Attribute.DateTime
    skuId: Schema.Attribute.String & Schema.Attribute.Required & Schema.Attribute.Unique
    updatedAt: Schema.Attribute.DateTime
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private
    variant: Schema.Attribute.Relation<'manyToOne', 'api::product-variant.product-variant'>
  }
}
